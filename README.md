...
Contains custom `.dta` files with valid US callsign data that can be used for [MorseRunner](https://www.dxatlas.com/MorseRunner/) practice. All callsigns are valid and active US callsigns that were active in [FCC Database](https://data.fcc.gov/download/pub/uls/complete/l_amat.zip). FCC Data was downloaded on April 29, 2026. 
